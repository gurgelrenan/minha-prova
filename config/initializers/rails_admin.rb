...
RailsAdmin.config do |config|
  ...
  #     configure :teachers, :has_and_belongs_to_many_association 
  ...
  # config.model 'Core' do

  #   # You can copy this to a 'rails_admin do ... end' block inside your core.rb model definition

  #   # Found associations:

  #     configure :course, :belongs_to_association 
  #     configure :disciplines, :has_many_association 
  #     configure :teachers, :has_many_association 
  ...
  #     configure :teachers, :has_many_association 
  #     configure :disciplines, :has_many_association 
  #     configure :cores, :has_many_association 
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your discipline.rb model definition
  ...
  #     configure :core_id, :integer         # Hidden 
  #     configure :course_id, :integer         # Hidden 
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your test.rb model definition
  ...
  #     configure :teacher, :has_one_association 
